...
@Configuration
@MapperScan(basePackages = "com.example.spring_boot_mode.dao.flowable",
...
public class FlowableConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("flowableDataSource") DataSource dataSource) throws Exception {
        ...
        sessionFactoryBean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources(FlowableConfig.MAPPER_LOCATION));
