package com.example.spring_boot_mode.config.encrypt.sm4;

import com.example.spring_boot_mode.config.encrypt.getproperties.GetPropertiesContext;
...
//            String key = generateKey();
            String key = GetPropertiesContext.getProperties("SM4.Key");
